...
import static com.iotend.common.constant.InjectionFieldConstants.ORG_ID_CLASS;
import static com.iotend.common.constant.InjectionFieldConstants.ORG_ID_METHOD;

/**
 * @description: 实体类 - 岗位
 * @author: huang
 * @create: 2020-11-30 13:44
 */
@Data
@NoArgsConstructor
@AllArgsConstructor
