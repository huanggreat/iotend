...
public interface BizConstant {
     ...
     * 默认的定时任务组
     */
    String DEF_JOB_GROUP_NAME = "iotend-jobs-server";
    /**
     * 短信发送处理器
     */
    ...
    String AUTHORITY = "iotend-authority-server";
    String FILE = "iotend-file-server";
    String MSGS = "iotend-msgs-server";
    String OAUTH = "iotend-oauth-server";
    String GATE = "iotend-gateway-server";
    String ORDER = "iotend-order-server";
    String DEMO = "iotend-demo-server";
