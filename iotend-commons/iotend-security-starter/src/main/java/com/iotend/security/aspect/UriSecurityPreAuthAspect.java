package com.iotend.security.aspect;
...
public class UriSecurityPreAuthAspect implements ApplicationContextAware {
     ...
     */
    @Around("execution(public * com.iotend.base.controller.*.*(..)) || " +
            "@annotation(com.iotend.security.annotation.PreAuth) || " +
            "@within(com.iotend.security.annotation.PreAuth)"
    )
