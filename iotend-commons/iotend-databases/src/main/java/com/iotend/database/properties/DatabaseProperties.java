package com.iotend.database.properties;
...
import static com.iotend.database.properties.DatabaseProperties.PREFIX;
import static com.iotend.database.properties.MultiTenantType.SCHEMA;
...
public class DatabaseProperties {
    public static final String PREFIX = "iotend.database";
    /**
     * 是否启用 防止全表更新与删除插件
     *
     * @return
     ...
     * 租户库 前缀
     */
    private String tenantDatabasePrefix = "iotend_base";
     ...
     * 事务扫描基础包
     */
    private String transactionScanPackage = "com.iotend";
